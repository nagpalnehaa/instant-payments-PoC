...
public class PaymentRequest {
    ...
    @Pattern(
        ...
        message = "Must be ISO 8601 UTC format (e.g. 2004-02-21T17:00:00Z)"
    )
    @XmlElement
    ...
    // ✅ Getters and setters (NO JAXB annotations required here anymore)
    ...
    public void setPayerCountryCode(String payerCountryCode) { this.payerCountryCode = payerCountryCode; }
    ...
    public void setPayeeCountryCode(String payeeCountryCode) { this.payeeCountryCode = payeeCountryCode; }
